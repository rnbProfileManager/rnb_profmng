    ...
    <div class="main-layout">
        ...
        <aside>
            ...
            <ul class="sidebar-menu">
                ...
                <li><a href="/empProjectInsert" class="active">투입 인력 추가</a></li>
        ...
        <!-- MAIN CONTENT -->
        <main>
            <h1 class="main-title">투입 인력 추가</h1>
            <p class="main-subtitle">신규 투입 인력 정보를 입력해주세요</p>

			<div class="content-grid">
                <article class="content-card">
					<form action="/insertProjectEmpInfoData" method="post">
						<div class="">
							<label for="searchInput">프로젝트코드: <span class="required">*</span></label>
						...
						<div class="">
							...
							<input type="text" name="empCd" class="searchInput" placeholder="예: 홍길동" required>
						</div>
						<div class="">
							<label for="searchInput">프로젝트명: <span class="required">*</span></label>
							<input type="text" name="projectNm" class="searchInput" placeholder="예: 홍길동" required>
						</div>
						<div class="">
